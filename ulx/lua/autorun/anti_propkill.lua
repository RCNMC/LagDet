...
Frame:SetTitle( "Prop Protection" )
...
net.Recieve( "OpenDaMenu", function()
  ...
  function Reset (len, ply)
    
  end

local dafile = file.Open( "PropProtect/config.txt", r, "DATA" )
if file.Exists( "PropProtect/config.txt", "DATA" ) then
    local usergroups = dafile:ReadLine(1)
else
    file.Write( "PropProtect/config.txt", '-- User groups who can see admin notifications --\n"superadmin", "admin"\n\n-- Do NOT edit this file directly!! --\n\n--Config version: 1.0beta\n\n--Last Reset: Never' )	
    local usergroups = dafile:ReadLine(1)
end
